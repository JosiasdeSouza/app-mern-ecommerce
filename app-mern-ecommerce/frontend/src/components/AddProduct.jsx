      ...
      <Grid container alignContent="center" justifyContent="center" style={{ paddingTop: "50px" }}>
        <Paper elevation={3} style={{ width: 550 }}>
          <Grid container direction="column" alignItems="center" gap={3}>
            <Typography variant="h5" style={{ marginTop: 20 }}>Add Product</Typography>
            {["title", "brand", "category", "description", "discountPercentage", "images", "price", "rating", "stock", "thumbnail"].map((field) => (
              <TextField
                key={field}
